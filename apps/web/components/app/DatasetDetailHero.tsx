          ...
          <>
            <div className="flex items-center gap-2 mb-3 flex-wrap">
              {/* Status pill — distinguish PUBLISHED (green) from DRAFT
                  (amber). The previous render showed every dataset as
                  "● Published" green regardless of `data.isPublished`,
                  which is a publishing-workflow safety regression: a
                  draft dataset opened in a logged-in session could
                  visually misrepresent itself as live. Source
                  data-browser used a "PUBLIC DATASET" / "DRAFT"
                  uppercase eyebrow toggle (audit #15). */}
