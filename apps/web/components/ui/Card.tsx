 ...
 *
 * Tokens: `bg-bg-surface` + `ring-border-subtle` match the marketing site's
 * card surfaces. Light-mode only (the design bar across ndi-cloud.com is
 ...
 * headings increase by one. Most pages have a page-level h1 (Published
 * datasets / dataset name / Query) and then cards, so the natural next
 * level is h2. A card inside a card can pass `as="h3"` explicitly.
 */
