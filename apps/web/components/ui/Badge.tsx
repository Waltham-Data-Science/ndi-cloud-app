 ...
 *   pub:       soft blue "Published" pill matching marketing search.html
 *
 * Tracking/size match the mockup's tag treatment.
 */
...
const VARIANT: Record<Variant, string> = {
  default: 'bg-brand-navy text-white ring-1 ring-inset ring-brand-navy',
  outline:
  ...
  pub: 'bg-[#EAF4FF] text-[#0B5FA8] ring-1 ring-inset ring-[#C8DCF0]',
};
