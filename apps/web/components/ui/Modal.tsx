 ...
 *
 * Ports `ndi-data-browser-v2/frontend/src/components/ui/Modal.tsx` verbatim
 * with a `'use client'` directive (uses refs + window event listeners).
 *
 * Ships with a backdrop that closes on click + Escape. Content renders
 * in-place (no portal) — every caller mounts the Modal at the top of its
 * own subtree under the App shell.
 *
 * Focus behavior (data-browser audit 2026-04-22):
 ...
 *     modal opened.
 *
 * Tokens: brand-navy backdrop, bg-bg-surface panel, border-border-subtle
 * separator.
 */
