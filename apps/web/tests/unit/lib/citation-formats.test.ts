 ...
 *
 * Phase 6.6 REBUILD-3a: ported verbatim from
 * ndi-data-browser-v2/frontend/src/lib/citation-formats.test.ts.
 * Only adapter change: the source's `@/types/dataset-summary` import
 * resolves to `frontend/src/types/...` in the data-browser; the
 * monorepo equivalent is `@/lib/types/dataset-summary`. The exported
 * symbol surface is identical.
 */
