 ...
 * ndi-data-browser-v2/frontend/src/lib/orcid.test.ts. Pure-function
 * tests; only adapter change is the import path
 * (`./orcid` → `@/lib/orcid` to match the monorepo's tests-unit
 * layout outside of source-tree).
 */
