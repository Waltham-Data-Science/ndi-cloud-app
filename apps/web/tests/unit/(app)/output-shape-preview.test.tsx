/**
 * OutputShapePreview tests — Phase 6.5e port.
 *
 * Ported verbatim from `ndi-data-browser-v2/frontend/src/components/query/OutputShapePreview.test.tsx`
 * with the import path adapted for the monorepo (`@/data/...` →
 * `@/lib/data/...`, `./OutputShapePreview` →
 * `@/components/app/OutputShapePreview`).
 *
 * Static component; no hooks. Verifies the rendered column-set headers
