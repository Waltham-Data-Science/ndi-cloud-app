 ...
 * ndi-data-browser-v2/frontend/src/lib/citation-formats.ts. No
 * adapter changes — pure TypeScript with the same `@/types/dataset-summary`
 * import path that the target already exposes.
 */
import type {
