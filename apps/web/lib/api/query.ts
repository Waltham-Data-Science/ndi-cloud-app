...
/**
 * Query API — query-builder mutation, "appears elsewhere" lookup, and
 * the supported-operations catalog. Ported verbatim from
 * `ndi-data-browser-v2/frontend/src/api/query.ts`.
 */
